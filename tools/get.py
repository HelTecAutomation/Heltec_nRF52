...
def unpack(filename, destination):
    ...
    if "CMSIS" in name:
        if os.path.isdir("CMSIS"):
            shutil.rmtree("CMSIS")
        shutil.move(name, "CMSIS")
    elif "gcc-arm-none-eabi" in name:
        if os.path.isdir("gcc-arm-none-eabi"):
            shutil.rmtree("gcc-arm-none-eabi")
        shutil.move(name, "gcc-arm-none-eabi")
